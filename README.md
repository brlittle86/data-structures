...
- For Merge Sort, we take in an array, determine a low/high index, then recursively divide the array into subsections until each value in the array is its own subsection. The recursive calls then pull off the stack as neighboring subsections go through a comparative merge sequence.
